...
const CAST_MANUAL_STEPS: StepItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      '【同伴報告】お客様と同伴出勤する場合、ダッシュボードから誰と同伴予定かを登録します。予約管理システムと連動するため忘れずに登録してください。',
    ],
    note: {
      type: 'caution',
  ...
  },
  {
    ...
    items: [
      ...
      '魅力的なプロフィール写真は指名数に直結します。ギャラリー機能（開発中）でお気に入りの写真を整理できます。',
  ...
  return (
    <div
      className={`
        ...
        border
        ${isOpen
          ? 'border-[#dfbd6930] bg-[#141416]'
          : 'border-white/8 bg-[#131720] hover:border-[#dfbd6920]'
        }
        group
      `}
    >
