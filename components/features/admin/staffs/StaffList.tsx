      ...
      <div className="bg-white border border-gray-100 rounded-sm overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              <th className="text-left px-4 py-3 font-medium text-gray-500 tracking-widest text-xs">名前</th>
              <th className="text-left px-4 py-3 font-medium text-gray-500 tracking-widest text-xs">表示名</th>
              <th className="text-left px-4 py-3 font-medium text-gray-500 tracking-widest text-xs">役職</th>
              <th className="text-left px-4 py-3 font-medium text-gray-500 tracking-widest text-xs">ステータス</th>
          ...
          <tbody className="divide-y divide-gray-50">
            {staffs.map((staff) => (
              <tr key={staff.id} className="hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3 font-medium text-[#171717]">{staff.name}</td>
                <td className="px-4 py-3 text-gray-600">{staff.display_name}</td>
                <td className="px-4 py-3 text-gray-500 text-xs">{staff.role ?? '—'}</td>
                ...
                <td className="px-4 py-3 text-right">
                  <Link
                    ...
                    className="inline-flex items-center gap-1 text-xs text-gray-400 hover:text-gold transition-colors"
                  >
                    <Edit size={13} />
                    編集
                  </Link>
