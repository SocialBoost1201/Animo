      ...
      {cards.map((card) => {
        ...
        return (
          <Link
            key={card.id}
            href={card.href}
            className={`group relative flex flex-col bg-[#17181c] rounded-[18px] overflow-hidden border border-[#8a8478] hover:border-[#dfbd69] transition-all duration-300 hover:shadow-2xl h-[150px] min-w-0 ${card.width}`}
          >
