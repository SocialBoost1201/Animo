      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            {/* Left: Store Info */}
            <FadeIn>
              <h2 className="text-xl font-serif text-foreground mb-12 luxury-tracking uppercase border-b border-[var(--color-gold)]/30 pb-4 inline-block">
                Store Info
              </h2>
              <dl className="space-y-10 text-sm text-gray-600 font-serif leading-[2.2] tracking-wider">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <dd className="leading-loose">
                    <span className="text-[10px] text-[var(--color-gold)] uppercase luxury-tracking block mb-1">Address</span>
                    〒231-0012<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <dd className="leading-loose">
                    <span className="text-[10px] text-[var(--color-gold)] uppercase luxury-tracking block mb-1">Building</span>
                    グランドパークビル
                  </dd>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <dd>
                    <span className="text-[10px] text-[var(--color-gold)] uppercase luxury-tracking block mb-1">Tel</span>
                    <a href="tel:045-263-6961" className="hover:text-[var(--color-gold)] transition-colors">
                      045-263-6961
                    </a>
                  </dd>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <dd className="leading-loose">
                    <span className="text-[10px] text-[var(--color-gold)] uppercase luxury-tracking block mb-1">Open Hours</span>
                    19:00 – LAST
                  </dd>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <dd className="leading-loose">
                    <span className="text-[10px] text-[var(--color-gold)] uppercase luxury-tracking block mb-1">Nearest Station</span>
                    JR根岸線・横浜市営地下鉄<br />
            ...
            <FadeIn delay={0.2} className="flex flex-col gap-4">
              <div className="overflow-hidden border border-[var(--color-gold)]/20 shadow-aura rounded-sm w-full h-[420px] relative">
                <iframe
              ...
              <a
                ...
                className="text-[10px] text-center text-[var(--color-gold)] font-serif luxury-tracking uppercase hover:underline transition-all"
              >
                Google Mapsで開く →
              </a>
            </FadeIn>
          ...
          {/* Divider */}
          <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-[var(--color-gold)]/30 to-transparent mt-24 mb-16" />
          ...
          <FadeIn delay={0.3} className="max-w-2xl mx-auto">
            ...
            <ul className="space-y-6 text-sm text-gray-600 font-serif leading-[2.2] tracking-wider">
              <li className="flex items-start gap-4 border-b border-gray-100/50 pb-6">
                ...
                <div>
                  <p className="text-foreground font-serif mb-1">
                    JR根岸線「関内駅」北口より <strong className="text-[var(--color-gold)]">徒歩 約5分</strong>
                  </p>
              ...
              <li className="flex items-start gap-4 border-b border-gray-100/50 pb-6">
                ...
                <div>
                  <p className="text-foreground font-serif mb-1">
                    横浜市営地下鉄ブルーライン「関内駅」より <strong className="text-[var(--color-gold)]">徒歩 約5分</strong>
                  </p>
