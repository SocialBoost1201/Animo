      ...
      >
        ...
        >
          <div className="text-center mb-5">
            ...
            <h1 className="text-2xl font-bold tracking-[0.2em] uppercase mb-3 bg-[linear-gradient(90deg,rgba(223,189,105,1)_0%,rgba(146,111,52,1)_100%)] bg-clip-text text-transparent">
              ANIMO CMS
            </h1>
            <p
