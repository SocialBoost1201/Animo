      ...
      <div className="bg-[#17181c] rounded-[18px] border border-[#ffffff0f] overflow-hidden">
        ...
        {total === 0 ? (
          <div className="py-16 text-center">
            ...
            <p className="text-[12px] text-[#5a5650] italic mb-4">顧客データがありません</p>
            <Link
              href="/admin/customers/new"
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-[#ffffff08]">
                {customers?.map((c) => {
                  ...
                  return (
                    <tr key={c.id} className="hover:bg-[#ffffff04] transition-colors group">
                      <td className="px-5 py-3.5">
                        <Link
                          href={`/admin/customers/${c.id}`}
                          className="text-[12px] font-semibold text-[#c7c0b2] hover:text-[#f4f1ea] transition-colors"
                        >
                          {c.name || '–'}
                        </Link>
                      </td>
                      ...
                      <td className="px-5 py-3.5 text-right">
                        <div className="flex items-center justify-end gap-1">
                          <Link
                            href={`/admin/customers/${c.id}`}
                            className="p-1.5 rounded-md text-[#8a8478] hover:text-[#dfbd69] hover:bg-[#dfbd691a] transition-colors"
                            title="編集"
                          >
                            <Pencil size={13} />
                          </Link>
